...
<%
String atransfer = request.getParameter("atransfer"); 
String pickupdrop = request.getParameter("pickupdrop");
...
<b style="color:#F60; font-size:18px;">Register</b><img src="img/x.png" alt='quit' class='x' id='x' />
       ...
       <form action="mail.jsp">
					<input type="hidden" name="atransfer" value="<%= atransfer %>">
					<input type="hidden" name="pickupdrop" value="<%= pickupdrop %>">
					<input type="hidden" name="date" value="<%= date %>">
					<input type="hidden" name="time" value="<%= time %>"> 
					<input type="hidden" name="atinfo" value="Airport Transfer">       			
					<label>Name</label>
