...
<div id="content-wrapper">
    ...
    <div class="browser">
                    <table width="100%">
                    <form action="airportcars.jsp">
                    <tr>
                    <td>AIRPORT TRANSFER</td></tr>
                    <tr>
                     <td><select name="atransfer"><option value="Going to Chennai Airport" >Going to Chennai Airport</option>
                     <option value="Coming from chennai Airport">Coming from chennai Airport</option>
                     </select></td>
                    </tr>
                    <tr><td>PICK UP/DROP AREA</td></tr>
                    <tr>
                    <td><select name="pickupdrop">
...
<option value="West Mambalam ">West Mambalam   </option>
                    ...
                    <tr><td>DATE</td></tr>
                    <tr><td>
                    <input type="date" placeholder="Date" name="date" required="required"></td>
                    </tr>
                    <tr><td>TIME</td></tr>
                    <tr><td><input type="time" placeholder="Time" name="time" required="required"></td></tr>
                    <tr align="right">
                    <td colspan="2" >
         ...
         <h4 align="center" style="color:white;">24/7 Helpline: 8122113030</h4>
            ...
            <h4 align="center" style="color:white;">Head Office: 044-42613955</h4></p>
        	  ...
        	  <select style="width:90%; height:50px; margin-top:10px; padding-left:7%; background-color:#fcb23a; color:#FFF; font-size:18px; border-radius:10px;"  name="forma" onchange="location = this.options[this.selectedIndex].value;">
                    ...
                    <option selected>Airport Trasfer</option>
    ...
    <div class="app-download">
                ...
                <form action="airportcars.jsp">
              		<table width="100%">
              		<tr><td><labeL>AIRPORT TRANSFER</labeL></td></tr>
                    <tr><td><select name="atransfer"><option value="Going to Chennai Airport" >Going to Chennai Airport</option>
                     <option value="Coming from chennai Airport">Coming from chennai Airport</option>
                     </select></td></tr>
                  <tr><td> <label>PICK UP/DROP AREA</label></td></tr>
                  <tr><td> <select name="pickupdrop">
                    <option value="Adambakkam">Adambakkam      </option>
<option value="Adyar">Adyar   </option>
<option value="Alandur">Alandur   </option>
<option value="Alwarpet  ">Alwarpet   </option>
...
<option value="West Mambalam ">West Mambalam   </option>
                   ...
                   <tr><td> <input type="date" placeholder="Date" name="date" required="required"></td></tr>
                  <tr><td>  <label>TIME</label></td></tr>
                   <tr><td>  <input type="time"  name="time" required="required"></td></tr>
                    <tr><td><input type="submit" value="Find Taxi" ></td></tr>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","licenseKey":"30bf98aefd","applicationID":"2794852","transactionName":"Z10EMRZWV0NUUBEPDV4XJwYQXlZeGlYEFRtvTAcdDWhKWUFWOg4NXV0WBANS","queueTime":0,"applicationTime":233,"ttGuid":"","agentToken":"","userAttributes":"","errorBeacon":"jserror.newrelic.com","agent":"js-agent.newrelic.com\/nr-361.min.js"}</script></body>
</html>