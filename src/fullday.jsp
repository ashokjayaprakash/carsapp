...
<head>
    ...
    <title>Full-Half Day Booking	</title>
                <!-- Favicon -->
...
<div id="content-wrapper">
    ...
    <div class="browser">
                    <table width="100%">
                    <form action="fulldaycars.jsp">
                    <tr><td>PACKAGE</td></tr>
                    <tr>
                    <TD><select name="packages"><option value="3Hrs 30Kms">3Hrs 30Kms</option>
						<option value="4Hrs 40Kms" >4Hrs 40Kms</option> 
                        <option value="5Hrs 50Kms">5Hrs 50Kms</option> 
                        <option value="6Hrs 60Kms">6Hrs 60Kms</option> 
                        <option value="7Hrs 70Kms">7Hrs 70Kms</option> 
                        <option value="8Hrs 80Kms">8Hrs 80Kms</option> 
                        <option value="9Hrs 90Kms">9Hrs 90Kms</option> 
                        <option value="10Hrs 100Kms">10Hrs 100Kms</option> 
                        <option value="11Hrs 110Kms" >11Hrs 110Kms</option> 
...
<option value="West Mambalam ">West Mambalam   </option>
    ...
    <div class="app-download">
                ...
                <div class="mobform">
                	 <table width="100%">
                    <form action="fulldaycars.jsp">
                    <tr><td><label>PACKAGE</label></td></tr>
                    <tr>
                    <TD><select name="packages"><option value="3Hrs 30Kms">3Hrs 30Kms</option>
						<option value="4Hrs 40Kms" >4Hrs 40Kms</option> 
                        <option value="5Hrs 50Kms">5Hrs 50Kms</option> 
