...
<head>
    ...
    <meta name="description" content="Carsapp is a corprate call taxi service which provides high end service for the customers">
                        ...
                        <title>Out Station Booking	</title>
                <!-- Favicon -->
...
.browser  input[type="text"]   { border: 1px solid #cccccc; -webkit-border-radius: 2px; -moz-border-radius: 2px; -ms-border-radius: 2px; -o-border-radius: 2px; border-radius: 5px; -webkit-box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.1); -moz-box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.1); box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.1); color: rgba(0, 0, 0, 0.75); display: block; font-size: 14px; margin: 0 0 12px 0;  height: 30px; width: 193px; -webkit-transition: all 0.15s linear; -moz-transition: all 0.15s linear; -o-transition: all 0.15s linear; transition: all 0.15s linear; } 	
...
.mobform label {font-size:14px; width:40%; color:#FFF; margin-left:5%;}
.mobform select,input[type="date"],input[type="time"]{width:75%; margin-left:5%;height: 40px;}
.mobform input[type="text"]{width:72%; margin-left:5%;height: 30px;}
...
<div id="content-wrapper">
    ...
    <form action="outcars.jsp">
                    ...
                    <td>TO</td></tr>
                    <tr>
                     <td><input type="text" required name="to" ></td>
                    </tr>
                    
                    <tr><td>DEPARTURE DATE</td></tr>
                    <tr><td>
                    <input type="date" required name="depdate"></td>
                    </tr>
                    <tr><td>ARRIVAL DATE</td></tr>
                    <tr><td><input type="DATE" required name="arrdate"></td></tr>
                    <tr align="right">
                    <td colspan="2" >
        ...
        <p align="center">
         <h4 align="center" style="color:white;">24/7 Helpline: 8122113030</h4>
            ...
            <h4 align="center" style="color:white;">Head Office: 044-42613955</h4></p>
        	 ...
        	 <select style="width:100%; height:50px; margin-top:10px; padding-left:10%; background-color:#fcb23a; color:#FFF; font-size:18px; border-radius:10px;"  name="forma" onchange="location = this.options[this.selectedIndex].value;">
    ...
    <div class="app-download">
                ...
                <div class="mobform">
                    ...
                    <tr>
                    <td><label>TO</label></td></tr>
                    <tr>
                     <td><input type="text" name="to" required></td>
                    </tr>
                    
                    <tr><td><label>DEPARTURE DATE</label></td></tr>
                    <tr><td>
                    <input type="date" required name="depdate"></td>
                    </tr>
                    <tr><td><label>ARRIVAL DATE</label></td></tr>
                    <tr><td><input type="DATE" required name="arrdate"></td></tr>
                    <tr >
                    <td  >
